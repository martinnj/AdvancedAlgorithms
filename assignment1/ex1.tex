...
\noindent Below we have illustrated the $b$-flow for figure (a). We see that
each node satisfies equation \ref{eq:1} and \ref{eq:2}, giving us the $b$-flow
illustrated.
...
with some of the nodes. Node $v_4$ does not satisfy the equations, and because
of that we have no $b$-flow here.
